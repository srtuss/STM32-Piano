...
void dacTest_put(float left, float right)
{
	HAL_DAC_SetValue(&hdac, DAC_CHANNEL_1, DAC_ALIGN_12B_R, 0x800 + (int)(0x3FF * left));
	HAL_DAC_SetValue(&hdac, DAC_CHANNEL_2, DAC_ALIGN_12B_R, 0x800 + (int)(0x3FF * right));
}
